...
const InputField = React.memo<InputFieldProps>(({ id, label, value, onChange, type = 'text', placeholder, className, name, icon, prefix, noLabel, autoComplete, step, error }) => {
...
const RichTextarea = React.memo((({ label, name, value, onChange, placeholder, rows = 3 }: {
    label: string;
    name: string;
    value: string;
