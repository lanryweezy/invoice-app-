  ...
  const handleTest = async () => {
    ...
    try {
      ...
      if (res.ok) {
        setMessage({
          type: "success",
          text: "Test email sent! Check your inbox (and spam folder).",
        });
      } else {
        setMessage({
          type: "error",
          text: data.error || "Test failed. Check your credentials.",
        });
      }
    } catch (err: any) {
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div
          className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg border border-slate-200 animate-in fade-in zoom-in duration-200 max-h-[90vh] overflow-y-auto"
          ...
          <div className="sticky top-0 bg-white border-b border-slate-100 px-6 py-4 flex justify-between items-center z-10">
            <div>
              ...
              >
                {step === "choose"
                  ? "Connect Your Email"
                  : `Setup ${selectedPreset?.name || "Custom"}`}
              </h3>
          ...
          <div className="p-6">
            {!isPro ? (
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border-slate-300 text-sm focus:border-teal-500 focus:ring-teal-500 pr-16"
                    />
                    <button
                      type="button"
                ...
                {message && (
                  <div
                    className={`px-3 py-2 rounded-lg text-sm font-medium ${message.type === "success" ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"}`}
                  >
                    {message.text}
                  </div>
                )}
