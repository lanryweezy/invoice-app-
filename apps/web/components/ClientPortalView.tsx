    ...
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-8 text-center border border-slate-100">
            ...
            <button onClick={() => setPaymentSuccess(false)} className="text-sm text-slate-400 hover:text-slate-600 font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-500 rounded px-2 py-1">
