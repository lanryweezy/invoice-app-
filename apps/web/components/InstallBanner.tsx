          ...
          <div className="flex-1">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-5 py-2 bg-white text-teal-700 font-bold rounded-xl text-sm hover:bg-teal-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-teal-500 transition-colors"
              >
                Install Now
              </button>
              <button
                onClick={dismissPrompt}
                className="px-4 py-2 text-teal-100 font-medium text-sm hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-200 transition-colors"
              >
                Not Now
              </button>
            </div>
