...
export const CommandPaletteProvider: React.FC<ProviderProps> = ({ onNavigate, onAction }) => {
  ...
  const actions = [
    {
      id: 'go-editor',
      label: 'Go to Invoice Editor',
      onSelect: () => onNavigate('editor'),
      icon: (
    ...
    {
      id: 'go-accounting',
      label: 'View Accounting & Expenses',
      onSelect: () => onNavigate('accounting'),
      icon: (
  ...
  return <CommandPalette isOpen={isOpen} onClose={() => setIsOpen(false)} actions={actions} />;
};
