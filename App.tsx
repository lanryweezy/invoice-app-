  ...
  return (
    <div className="h-screen flex flex-col bg-slate-50 text-slate-800 font-sans overflow-hidden selection:bg-teal-100 selection:text-teal-900">
      <Helmet>
        ...
        <meta name="description" content={invoice.user.name ? `Invoice generated by ${invoice.user.name} using Naija Invoice Generator.` : "Create professional invoices in seconds. The #1 free invoice generator tailored for Nigerian freelancers and businesses."} />
